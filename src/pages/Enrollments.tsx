    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card className="card-athletic">
          ...
          <CardContent>
            <div className="text-2xl font-bold">$21,240</div>
                ...
                <div className="flex items-center gap-4 lg:w-1/4">
                  <Avatar className="h-12 w-12">
                    ...
                    <AvatarFallback className="bg-gradient-primary text-primary-foreground">
                      {getInitials(enrollment.trainee.name)}
                    </AvatarFallback>
                  </Avatar>
                ...
                <div className="lg:w-1/4">
                  <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-1 text-xs text-muted-foreground">
                      ...
                      {enrollment.coach} • {enrollment.branch}
                    </div>
                  </div>
                </div>
                ...
                <div className="lg:w-1/4">
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      <span>Progress</span>
                      <span>{enrollment.sessionsCompleted}/{enrollment.totalSessions}</span>
                    </div>
                    <div className="w-full bg-muted rounded-full h-2">
                      <div 
                        className="h-2 rounded-full bg-primary"
                        style={{ width: `${getProgressPercentage(enrollment.sessionsCompleted, enrollment.totalSessions)}%` }}
                      />
                    </div>
                    <p className="text-xs text-muted-foreground">
                      {getProgressPercentage(enrollment.sessionsCompleted, enrollment.totalSessions)}% complete
                    </p>
                  </div>
                </div>
