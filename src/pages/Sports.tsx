  ...
  const sports = [
    {
      ...
      name: "Basketball",
      category: "Team Sport",
      description: "Fast-paced team sport focusing on agility, teamwork, and strategic thinking.",
      ...
      monthlyFee: 120,
      coaches: 4,
      branches: ["Main Campus", "Downtown"],
      equipment: ["Basketball", "Hoops", "Protective Gear"],
      status: "Active"
    },
    {
      id: 2,
      ...
      description: "Full-body workout sport that builds endurance, strength, and technique.",
      skillLevel: ["Beginner", "Intermediate", "Advanced", "Competitive"],
      ageGroups: ["4-8", "9-15", "16+"],
      duration: "45 min",
      maxParticipants: 8,
      ...
      equipment: ["Pool", "Lane Ropes", "Kickboards", "Safety Equipment"],
      status: "Active"
    },
    {
      id: 3,
      ...
      description: "Individual or doubles sport focusing on precision, strategy, and athleticism.",
      skillLevel: ["Beginner", "Intermediate", "Advanced"],
      ageGroups: ["8-14", "15+"],
      duration: "75 min",
      maxParticipants: 4,
      ...
      monthlyFee: 180,
      coaches: 3,
      branches: ["Main Campus", "Westside"],
      equipment: ["Racquets", "Tennis Balls", "Court", "Nets"],
      status: "Active"
    },
    {
      id: 4,
      ...
      description: "Traditional martial arts focusing on discipline, self-defense, and mental strength.",
      skillLevel: ["Beginner", "Intermediate", "Advanced", "Black Belt"],
      ageGroups: ["5-10", "11-17", "18+"],
      duration: "90 min", 
      maxParticipants: 15,
      ...
      equipment: ["Mats", "Protective Gear", "Training Equipment"],
      status: "Active"
    }
  ];
          ...
          <Card key={sport.id} className="card-athletic">
            <CardContent className="p-6">
              <div className="flex items-start justify-between mb-4">
                ...
                <Badge className={getStatusColor(sport.status)}>
                  {sport.status}
                </Badge>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                ...
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span>${sport.monthlyFee}/month</span>
                </div>
                <div className="flex items-center gap-2 text-sm">
                  <Star className="h-4 w-4 text-muted-foreground" />
                  <span>{sport.coaches} coaches</span>
                </div>
              </div>
              ...
              <div className="mb-4">
                <div className="flex justify-between text-sm mb-2">
                  ...
                  <span className="font-medium">{sport.currentEnrollment}</span>
                </div>
              </div>
              ...
              <div className="mb-4">
                ...
                <div className="flex flex-wrap gap-1">
                  {sport.branches.map((branch) => (
                    <Badge key={branch} className="text-xs bg-primary/10 text-primary">
                      {branch}
                    </Badge>
                  ))}
                </div>
